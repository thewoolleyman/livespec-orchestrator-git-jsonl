...
awareness" — the impl-plaintext consumers MUST call
...
from livespec_impl_plaintext.commands import _jsonc
...
def load_manifest(*, project_root: Path) -> CrossRepoManifest:
    ...
    the impl-plaintext consumers tolerate degraded manifest views and
