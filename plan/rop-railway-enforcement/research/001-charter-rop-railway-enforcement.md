# Charter — rop-railway-enforcement (livespec-orchestrator-git-jsonl)

Opened 2026-09-12 at the maintainer's direction. This is the livespec-orchestrator-git-jsonl realization of the
...
- **This repo's scope, as of the coordinating campaign:** 8 off railway (universe re-derive).
- **Coordinating campaign (authoritative ledger):** livespec-dev-tooling epic
  `livespec-dev-tooling-8o8e`, arming child `livespec-dev-tooling-8o8e.11` for this repo.
